...
export default function DateBlock({ block }: Props) {
  ...
  if (variant === 'modern') {
    return (
      <div className={`w-full px-6 py-12 text-center ${className || ''}`} style={containerStyle}>
  ...
  if (variant === 'classic') {
    return (
      <div className={`w-full px-6 py-10 text-center font-serif ${className || ''}`} style={containerStyle}>
  ...
  if (variant === 'circle') {
     return (
      <div className={`w-full px-6 py-10 flex justify-center ${className || ''}`} style={containerStyle}>
  ...
  // Default
  return (
    <div className={`w-full p-6 text-center ${className || ''}`} style={containerStyle}>
